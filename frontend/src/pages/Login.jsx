...
function Login() {
    ...
    const handleSubmit = async (e) => {
        ...
        if (!formData.email || !formData.parola) {
        ...
        try {
            ...
            setEroare(err.response?.data?.message || 'Eroare la autentificare, încearcă din nou');
        }
    };
                    ...
                    <div className="space-y-4 rounded-md">
                        ...
                        <div>
                            ...
                            <input
                                ...
                                onChange={handleChange}
                                className="block w-full rounded-md border border-gray-300 px-3 py-2 text-gray-900 placeholder-gray-400 focus:border-blupurplee-500 focus:outline-none focus:ring-1 focus:ring-purple-500 sm:text-sm"
